function [sample_results condwaves condfiles_subs condwaves_trim] = pbgroup1way(STATS,condfiles, numconds, numpnts, nboot, jlvls, alpha, design, condnames, varargin)
tic
