function [sample_results condwaves condfiles_subs condwaves_trim] = pbgroup1way(STATS,condfiles, numconds, numpnts, nboot, jlvls, alpha, nsamp, design, condnames, varargin)
tic
...
% %%% stopping group inferential jan 8th 2016
