function [inferential_results sample_results condwaves condfiles_subs condwaves_trim] = pbgroup1waytf(STATS, condfiles, numconds, numpnts, nboot, jlvls, alpha, nsamp, design, condnames, varargin)
tic
