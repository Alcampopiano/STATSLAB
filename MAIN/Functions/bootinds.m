function [rowfile cond_bootvect tmpfname] = bootinds(condfiles_subs,nsamp,design,jlvls,klvls)

%[rowfile cond_bootvect tmpfname] = bootinds(condfiles_subs,nsamp,design,varargin)
...
switch design
    ...
    case 'bw'
        ...
        for j=1:jlvls; %between lvls
            ...
            [rowfile(j) colfile]=size(condfiles_subs{1,q}(:,1));
