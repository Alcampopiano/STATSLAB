...
switch isfactorial
    case 0
        ...
        for i=1:numfigs
            ...
            h(1)=surf(STATS.TF_times,STATS.TF_freqs,double(plot1st),'facecolor','interp','linestyle','none'); axis tight; view(0,90);
            ...
            h(2)=surf(STATS.TF_times,STATS.TF_freqs,double(plot2nd),'facecolor','interp','linestyle','none'); axis tight; view(0,90);
            if ersp==1; colormap(jet); caxis(conds_ax); cbfreeze(colorbar); freezeColors; end
            if itc==1; colormap(flipud(hot)); caxis(conds_ax); cbfreeze(colorbar); freezeColors; end
            
            hsub(3)=subplot(4,1,3);
            h(3)=surf(STATS.TF_times,STATS.TF_freqs,double(plotdiff),'facecolor','interp','linestyle','none'); axis tight; view(0,90);
            colormap(jet); caxis(conds_axdiff); cbfreeze(colorbar); freezeColors;
            
            hsub(4)=subplot(4,1,4);
            h(4)=surf(STATS.TF_times,STATS.TF_freqs,double(pvals),'facecolor','interp','linestyle','none'); axis tight; view(0,90);
    ...
    case 1
        ...
        if ~isempty(options.FactorAB);
            ...
            for i=1:numfigs
                ...
                h(1)=surf(STATS.TF_times,STATS.TF_freqs,double(plotdiff),'facecolor','interp','linestyle','none'); axis tight; view(0,90);
                colormap(jet); caxis(conds_axdiff); cbfreeze(colorbar); freezeColors;
                
                hsub(2)=subplot(2,1,2);
                h(2)=surf(STATS.TF_times,STATS.TF_freqs,double(pvals),'facecolor','interp','linestyle','none'); axis tight; view(0,90);
                colormap(bone(2)); caxis([0 1]); hb=cbfreeze(colorbar); set(hb,'YTick',[0 1]); freezeColors;
